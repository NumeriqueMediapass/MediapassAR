...
urlpatterns = [
    ...
    path('admininstration/edit_user/<int:idusers>', UsersEdit, name='UsersEdit'),
    ...
    path('admininstration/edit_mediatheque/<int:idmedialibrary>', MediaLibraryEditing, name='MediaLibraryEditing'),
