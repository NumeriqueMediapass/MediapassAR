...
urlpatterns = [
    ...
    path('mediatheque/edit_atelier/<int:idanimations>', AtelierEditing, name='AtelierEditing'),
    path('mediatheque/delete_atelier.html', AtelierDelation, name='AtelierDelation'),
    path('mediatheque/confirm_inscription/<int:idanimations>', InscriptionGet, name='InscriptionGet'),
